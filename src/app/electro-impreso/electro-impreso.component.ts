...
@Component({
  selector: 'app-electro-impreso',
  templateUrl: './electro-impreso.component.html',
  styleUrls: ['./electro-impreso.component.css']
})
export class ElectroImpresoComponent implements OnInit {
...
buscarElectro() {
  ...
  //      });
  this.electroList  = this.electroServer.geAlltElectroNoInformados('3');
}
...
imprimir(p: Electro) {
  ...
  descargar(p: Electro) {
    ...
    doc.setFontSize(20);
    doc.text('Centro Médico Carlidad de Cobre', 60, 10);
    doc.text('Santa Raquel 9877, La Florida', 60, 20);
    doc.text('Fono: 2 2291 7050', 60, 30);
    ...
    doc.setFontSize(18);
    doc.text('Informe Médico' , 77, 100);
